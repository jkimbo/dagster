...
def this_lakehouse_table(feature_area, name=None, input_defs=None):
    def _wrap(fn):
        return lakehouse_table(
            name=name, metadata={FEATURE_AREA: feature_area}, input_defs=input_defs
        )(fn)
...
class ByFeatureParquetLakehouse:
    ...
    def hydrate(self, context, table_type, table_metadata, _table_handle):
